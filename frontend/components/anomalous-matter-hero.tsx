...
export function GenerativeArtScene() {
  ...
  useEffect(() => {
    ...
    const animate = (t: number) => {
      material.uniforms.time.value = t * 0.0001; // Slower animation
      mesh.rotation.y += 0.0002; // Much slower rotation
      mesh.rotation.x += 0.0001; // Much slower rotation
...
export function AnomalousMatterHero() {
  return (
    <section
      role="banner"
      className="fixed inset-0 w-full h-screen bg-black text-white overflow-hidden -z-10"
    >
